...
paths = {
    'config': '/lustrehome/home/a.mak80/Tensorflow/workspace/models/ssd_mobilenet_v1_fpn_640x640_coco17_tpu-8/pipeline.config',
    'checkpoint': '/lustrehome/home/a.mak80/Tensorflow/workspace/models/ssd_mobilenet_v1_fpn_640x640_coco17_tpu-8',
...
cv2.imwrite('5.test_image.jpg', image_np_with_detections)
print('Done')