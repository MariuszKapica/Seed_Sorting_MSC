...
paths = {
    'config': '/lustrehome/home/a.mak80/Tensorflow/workspace/models/ssd_resnet152_v1_fpn_1024x1024_coco17_tpu-8/pipeline.config',
    'checkpoint': '/lustrehome/home/a.mak80/Tensorflow/workspace/models/ssd_resnet152_v1_fpn_1024x1024_coco17_tpu-8',
...
cv2.imwrite('6.test_image.jpg', image_np_with_detections)
print('Done')